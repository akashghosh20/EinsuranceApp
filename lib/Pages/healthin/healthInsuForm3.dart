...
class healthInsuForm3 extends StatefulWidget {
  const healthInsuForm3({Key? key}) : super(key: key);

  @override
  _healthInsuForm3State createState() => _healthInsuForm3State();
}

class _healthInsuForm3State extends State<healthInsuForm3> {
  ...
  CollectionReference pids =
      FirebaseFirestore.instance.collection('healthInsurance3');
